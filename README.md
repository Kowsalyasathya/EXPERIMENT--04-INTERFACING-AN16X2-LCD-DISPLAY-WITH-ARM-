...
int main(void)
{
  ...
  Lcd_PortType ports[] = {GPIOA,GPIOA,GPIOA,GPIOA};
    ...
    Lcd_cursor(&lcd, 0,0);
    Lcd_string(&lcd, "KOWSALYA M");

    Lcd_cursor(&lcd,1,0);
        Lcd_string(&lcd, "212222230069");
        HAL_Delay(500);
  while (1)
  {
...
## Output screen shots of proteus  :
 ...
 ![WhatsApp Image 2024-04-02 at 9 22 05 PM](https://github.com/Kowsalyasathya/EXPERIMENT--04-INTERFACING-AN16X2-LCD-DISPLAY-WITH-ARM-/assets/118671457/2fff4d98-12af-4afc-abe2-bbf04ac185c6)
